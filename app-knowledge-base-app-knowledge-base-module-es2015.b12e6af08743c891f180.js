...
let EditPageComponent = class EditPageComponent {
    ...
    update(editform) {
        ...
        let api_req = '{"operation": "category","moduleType": "category","api_type": "web","element_data": {"action":"update_doc_post","post_title":"' + post_title + '","status":"' + status + '","category_id":"' + catselect + '","subcat_id":"' + subcatselect + '","post_content":"' + ck_editor + '","id":"' + this.param + '","display_type":"' + displaytype + '"}}';
        this.serverService.sendserver(api_req).subscribe((response) => {
            console.log(api_req);
            // return false;
            console.log(response);
...
let UploadpageComponent = class UploadpageComponent {
    ...
    postupload(uploadform) {
        ...
        // let subcat_id:any = $("#subcatselect").val();
        let quote_content = '';
        let post_by = $("#opt").val();
...
//# sourceMappingURL=app-knowledge-base-app-knowledge-base-module-es2015.b12e6af08743c891f180.js.map