...
if($action == "send_internal_chat_message"){    
    $chat_data = array("chat_sender_id"=>$chat_sender_id,"chat_receiver_id"=>$chat_receiver_id,"admin_id"=>$admin_id,"msg_from"=>"agent","msg_type"=>"text","chat_msg"=>$chat_msg,"timezone_id"=>$timezone_id);
