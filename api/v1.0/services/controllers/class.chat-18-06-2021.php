...
class chat extends restApi{
  ...
  //echo $queue_chat_qry; exit;
   ...
   $chat_detail_qry = "select * from (select chat_data_sms.chat_msg_id, chat_data_sms.delivered_status as msg_status, chat_data_sms.msg_from as msg_user_type,chat_data_sms.chat_id,chat_data_sms.chat_message as chat_msg,date_format(chat_data_sms.created_dt, '%d/%m/%Y') as chat_dt, TIME_FORMAT(chat_data_sms.created_dt, '%H:%i') as chat_time, chat_sms.app_customer_key as customer_name,chat_data_sms.chat_pnr as chat_pnr, users.user_name,users.profile_image, chat_data_sms.agent_id as msg_user_id, chat_sms.api_type as msg_type,  (select first_name from contacts where phone = chat_sms.customer_name and admin_id='$admin_id'  GROUP BY phone ) as cus_name  from chat_data_sms inner join chat_sms on chat_sms.chat_id = chat_data_sms.chat_id left join user as users on users.user_id = chat_data_sms.agent_id where chat_sms.chat_id LIKE '".$chat_id."' order by chat_data_sms.chat_msg_id desc LIMIT $limit OFFSET $offset) result_data order by chat_msg_id asc";
...
function addsinglepbxsettings($sip_port,$sip_url,$admin_id){    
  ...
  /*function mcEvents($user_id){    
	...
	$has_telegram = $admin_res['has_telegram'];
		...
		$vals=$has_sms1.','.$has_chat1.','.$has_whatsapp1.','.$has_telegram1.','.$has_fb1;
		 $vals="'" . str_replace(",", "','", $vals) . "'";
		//echo $vals;exit;
		
    if($admin_id==1){
     if($reseller==''){
        $mc_event_qry="(select event.mc_event_id,event.mc_event_key,event.mc_event_data,event.mc_event_type,event.wp_inst_id, queue_features.feature_name,event.event_desc,event.event_status,event.created_dt,event.page_name,event.page_picture,event.is_contact from mc_event event inner join queue_features on  event.mc_event_type = queue_features.feature_id WHERE event.admin_id='$user_id' and event.mc_event_type!='11') UNION
(select ev.mc_event_id,ev.mc_event_key,ev.mc_event_data,ev.mc_event_type,ev.wp_inst_id, qf.feature_name,ev.event_desc,ev.event_status,ev.created_dt,ev.page_name,ev.page_picture,ev.is_contact from mc_event ev inner join queue_features qf on  ev.mc_event_type = qf.feature_id WHERE ev.admin_id='$user_id' and ev.mc_event_type='11' group by ev.mc_event_key,date_format(ev.created_dt, '%Y-%m-%d %H:%i' ))
...
function insertChatMessage($chat_data){        
	...
	//echo $aid;exit;
	if($aid == '870'){
	$chat_data = array("timezone_id"=>$timezone_id,"phone_num"=>$mobile_num,"user_id"=>$agent_id,"chat_msg"=>$chat_msg,"admin_id"=>$aid,"from_external"=>"1");
...
// Web Chat
        ...
        function getcustomersChatWC($user_id,$queue_id,$search_text){
        $search_qry ="";
    if($search_text != ""){
      $search_qry .= "and customer.customer_name like '%".$search_text."%'";
    }
...
//print_r($result);exit;
  ...
  public function get_question(){    
      $get_queue_qry = "SELECT * FROM chat_question";     
...
<tr> 
<td style="padding: 0px; height: 80px; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; font-size:12px;font-weight:normal;color:#ffffff;line-height:20px;text-align:center;">
  <a href="https://www.facebook.com/Cal4care/" style="color:#ffffff;text-decoration:none;"><img src="https://omni.mconnectapps.com/api/v1.0/images/facebook.png"  width="30" height="30"></a>&nbsp;&nbsp;&nbsp;&nbsp;
   <a href="https://twitter.com/calncall" style="color:#ffffff;text-decoration:none;"><img src="https://omni.mconnectapps.com/api/v1.0/images/twitter.png"  width="30" height="30"></a>&nbsp;&nbsp;&nbsp;&nbsp;
 <a href="https://www.instagram.com/cal4care/" style="color:#ffffff;text-decoration:none;"><img src="https://omni.mconnectapps.com/api/v1.0/images/instagram.png"  width="30" height="30"></a>&nbsp;&nbsp;
...
<tr align="center"> 
<td align="center" style="padding: 30px 25px 30px 25px;background-color:#ffffff;color: #111149; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; min-width: auto !important; font-size: 24px; line-height: 30px; text-align: center; font-weight: 700;">- Conversation started on '.$chat_date.' -<br />Chat on '.$widget_name.'</td> 
</tr> 
<tr> 
<td> 
<!--START Body Copy Section 4--> 
...
<tr> 
<td style="padding: 10px 30px 10px 30px;background-color:#ffffff;color: #111149; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; min-width: auto !important; font-size: 17px; line-height: 26px; text-align: left; font-weight: normal;"><strong style="color:#111149; min-width: 150px; width: 150px; float: left; display: inline-block;  text-decoration:none;">Name : </strong> '.$customer_name.'</td> 
</tr>
<tr> 
<td style="padding: 0px 30px 10px 30px;background-color:#ffffff;color: #111149; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; min-width: auto !important; font-size: 17px; line-height: 26px; text-align: left; font-weight: normal;"><strong style="color:#111149; min-width: 150px; width: 150px; float: left; display: inline-block;  text-decoration:none;">Email : </strong> '.$customer_email.'</td> 
</tr>
<tr> 
<td style="padding: 0px 30px 10px 30px;background-color:#ffffff;color: #111149; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; min-width: auto !important; font-size: 17px; line-height: 26px; text-align: left; font-weight: normal;"><strong style="color:#111149; min-width: 150px; width: 150px; float: left; display: inline-block;  text-decoration:none;">Department : </strong> '.$chat_dept_name.'</td> 
</tr>
<tr> 
<td style="padding: 0px 30px 40px 30px;background-color:#ffffff;color: #111149; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; min-width: auto !important; font-size: 17px; line-height: 26px; text-align: left; font-weight: normal;"><strong style="color:#111149; min-width: 150px; width: 150px; float: left; display: inline-block;  text-decoration:none;">Question : </strong> '.$first_chat_msg.'</td> 
</tr>
<tr> 
<td style="padding: 0px 30px 40px 30px;background-color:#ffffff;color: #111149; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; min-width: auto !important; font-size: 17px; line-height: 26px; text-align: left; font-weight: normal;"><strong style="color:#111149; min-width: 150px; width: 150px; float: left; display: inline-block;  text-decoration:none;">IP : </strong> '.$customer_ip.'</td> 
</tr>
<tr> 
<td style="padding: 0px 30px 40px 30px;background-color:#ffffff;color: #111149; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; min-width: auto !important; font-size: 17px; line-height: 26px; text-align: left; font-weight: normal;"><strong style="color:#111149; min-width: 150px; width: 150px; float: left; display: inline-block;  text-decoration:none;">Country : </strong> '.$customer_country.'</td> 
</tr>  
</tbody> 
</table> 
</div> </td> 
...
<td align="center" style="background-color: transparent; height:40px;"> 
	  ...
	  foreach($result as $record){
		...
		if($user_profile_image==''){
		  $user_image = 'https://devomni.mconnectapps.com/api/v1.0/images/user.png';
		}else{
		  $user_image = $user_profile_image;
		}
        if($chat_user_type==2){
          $email_message.='<tr> 
<td style="padding: 15px 30px; background-color:#ffffff;color: #111149; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; min-width: auto !important; font-size: 17px; line-height: 26px; text-align: left; font-weight: normal;">
<img alt="" border="0" src="'.$user_image.'" style="display: inline-block; border: 0; outline: 0; padding: 0; width: 100%; max-width: 30px; height: 30px; margin-top: -5px; margin-left: auto; margin-right: 0px; border-radius: 50%; margin-bottom: 5px; border: 2px solid #e3e3e3; float: left; font-size: 26px; color: #111149;" width="30" />
<strong style="padding-left: 15px; color:#111149; float: left; text-decoration:none;"> '.$user_name.'</strong>: '.$chat_message.'
<i style="float: right;">['.$chat_time.']</i>
</td> 
</tr>';
        }else{
          $email_message.='<tr> 
<td style="padding: 15px 30px; background-color:#ffffff;color: #111149; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; min-width: auto !important; font-size: 17px; line-height: 26px; text-align: left; font-weight: normal;">
<img alt="" border="0" src="https://devomni.mconnectapps.com/api/v1.0/images/user.png" style="display: inline-block; border: 0; outline: 0; padding: 0; width: 100%; max-width: 30px; height: 30px; margin-top: -5px; margin-left: auto; margin-right: 0; border-radius: 50%; margin-bottom: 5px; border: 2px solid #e3e3e3; float: left; font-size: 26px; color: #111149;" width="30" />
<strong style="padding-left: 15px; color:#111149; float: left; text-decoration:none;"> '.$customer_name.'</strong>: '.$chat_message.'
<i style="float: right;">['.$chat_time.']</i>
</td> 
</tr>';
        }
	  ...
	  if($chat_rating !=''){
      $email_message.='<tr> 
<td style="padding: 0px 30px 10px 30px;background-color:#ffffff;color: #111149; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; min-width: auto !important; font-size: 17px; line-height: 26px; text-align: left; font-weight: normal;"><strong style="color:#111149; min-width: 150px; width: 150px; float: left; display: inline-block;  text-decoration:none;">Chat Rating : </strong> '.$chat_rating.'</td> 
</tr><tr>'; }
      $email_message.='<tr> 
<td align="center" style="background-color:#ffffff;padding:30px 0 30px 0;"> 
<table class="mw88" align="center" border="0" cellpadding="0" cellspacing="0" style="width: 169px;"> 
<tbody> 
<tr> 
<td align="center" height="43" style="width:169px;height:55px; background-color:#b33872;direction:ltr;" width="218"><a href=
"http://helpdesk.guru/" style=" display:inline-block; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; font-weight:bold; font-size:16px; color:#ffffff;  text-decoration:none; text-wrap: nowrap;padding: 10px 9px;"
> 
<!--[if mso]>&nbsp;&nbsp;<![endif]-->Helpdesk Guru
<!--[if mso]>&nbsp;&nbsp;<![endif]--></a></td> 
</tr> 
</tbody> 
</table> </td> 
...
function generate_incoming_message_from_outer($data){
    ...
    if($result > 0){
      ...
      $qry = "select * from user where user_id='$user_id'";
			...
			$qry = "INSERT INTO `chat_sms` (`app_chat_id`, `app_customer_key`, `customer_name`, `customer_pnr`, `api_type`, `assigned_agent`, `chat_status`, `chat_read_status`, `admin_id`,`created_at`, `country_code`) VALUES ('$phone_num', '$phone_num', '$phone_num', '', 'sms', '0', '1', '1', '$admin_id','$created_at','$country_code')";	
		//print_r($qry); exit;
 			$chat_id = $this->db_insert($qry, array());
		
            $chat_msg_id = $this->db_insert("INSERT INTO chat_data_sms(chat_id,msg_type, msg_from,agent_id, chat_message, delivered_status, chat_status, created_dt,send_by) VALUES ('$chat_id','text', 'customer','$user_id', '$chat_msg','1', '1','$created_at','Using Own SMS panel')", array());
          $chat_data = $this->getChatDetails($chat_msg_id);
		$mc_event_data = "SMS From ".$phone_num;
...
//echo $token;exit;
    ...
    curl_close($ch);
	 ...
	 /*	 
$options = array('en'=>$text);  
$array[] = $options;
$head = array("en" => 'Incoming Call');
$fields = array(
	'app_id' => "150fff9c-ee3c-40fd-bdd5-bd0eb2fe9cf9",
...
curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json; charset=utf-8', 'Authorization: Basic NGY2ZjQyNGItN2M2Ny00ODY3LTk3Y2YtMjZmYTRiZGFiOTJh'));
