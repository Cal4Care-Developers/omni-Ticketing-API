...
class chat extends restApi{
  ...
  //echo $queue_chat_qry; exit;
    ...
    function chatDetailList($chat_id, $admin_id){
...
function addsinglepbxsettings($sip_port,$sip_url,$admin_id){    
  ...
  /*function mcEvents($user_id){    
    ...
    if($admin_id==1){
     if($reseller==''){
      $mc_event_qry = "select event.mc_event_id,event.mc_event_key,event.mc_event_data,event.mc_event_type,event.wp_inst_id, queue_features.feature_name,event.event_desc,event.event_status,event.created_dt,event.page_name,event.page_picture,event.is_contact from mc_event event inner join queue_features on  event.mc_event_type = queue_features.feature_id WHERE event.admin_id='$user_id' order by event.mc_event_id DESC LIMIT 100";  }else{
			 $mc_event_qry = "select event.mc_event_id,event.mc_event_key,event.mc_event_data,event.mc_event_type,event.wp_inst_id, queue_features.feature_name,event.event_desc,event.event_status,event.created_dt,event.page_name,event.page_picture,event.is_contact from mc_event event inner join queue_features on  event.mc_event_type = queue_features.feature_id WHERE  event.admin_id IN($user_id,$reseller) order by event.mc_event_id DESC LIMIT 100";
		}    
      $parms = array();
      $result = $this->dataFetchAll($mc_event_qry,array());
    ...
    //  $mc_event_qry = "select event.mc_event_id,event.mc_event_key,event.mc_event_data,event.mc_event_type, queue_features.feature_name,event.event_desc,event.event_status,event.created_dt,event.page_name,event.page_picture,event.is_contact from mc_event event inner join queue_features on  event.mc_event_type = queue_features.feature_id WHERE event.admin_id='$admin_id' AND (find_in_set('$user_id', event.agents)) OR mc_event_type IN ($vals) order by event.mc_event_id DESC LIMIT 100";  
		
		// replace on 31-07-2020
		 $mc_event_qry = "select event.mc_event_id,event.mc_event_key,event.mc_event_data,event.mc_event_type,event.wp_inst_id, queue_features.feature_name,event.event_desc,event.event_status,event.created_dt,event.page_name,event.page_picture,event.is_contact from mc_event event inner join queue_features on  event.mc_event_type = queue_features.feature_id WHERE event.admin_id='$admin_id' AND ( mc_event_type IN ($vals) or mc_event_type='3' )order by event.mc_event_id DESC LIMIT 100";
		// mc_event_type IN ($vals) 
...
$sel="SELECT IF(user.admin_id = 1, user.user_id , user.admin_id ) as admin_id from user where user_id='$agent_id'";
  ...
  if($result == '1: Message sent successfully @  '){	  
	...
	$mc_event_data = "SMS To".$mobile_num;
        $this->db_query("INSERT INTO mc_event (admin_id,mc_event_key,mc_event_data,mc_event_type,event_status,created_dt) VALUES('$aid','$chat_id','$mc_event_data','6','7','$created_at')", array());
...
<tbody> 
<tr align="center"> 
<td align="center" style="padding:40px 25px 10px 25px;background-color:#ffffff;color: #111149; font-family: Post Grotesk, Avenir, Century Gothic, Helvetica, sans-serif; min-width: auto !important; font-size: 24px; line-height: 26px; text-align: center; font-weight: 700;">Customer Close Abruptly</td> 
</tr> 
...
<strong>Chat on calncall.com</strong><br>
</div>
</td>
</tr>
<tr>
...
<td style="color:#FFFFFF; font-family:"PT Sans", "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 15px; line-height: 24px; margin: 0; padding: 0 0 15px 0;">Naveen J</td>
</tr>
</table>
<table>
<tr>
...
<td style="color:#FFFFFF; font-family:"PT Sans", "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 15px; line-height: 24px; margin: 0; padding: 0 0 15px 0;">jn@cal4care.com</td>
</tr>
</table>
<table>
...
<td style="color:#FFFFFF; font-family:"PT Sans", "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 15px; line-height: 24px; margin: 0; padding: 0 0 15px 0;">sales</td>
</tr>
</table>
<table>
<tr>
<td width="50"></td>
<td width="120" style="color:#FFFFFF; font-family:"PT Sans", "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 15px; line-height: 24px; margin: 0; padding: 0 0 15px 0;">Question </td>
<td style="color:#FFFFFF; font-family:"PT Sans", "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 15px; line-height: 24px; margin: 0; padding: 0 0 15px 0;">
would like to know more about the advantage of using your service during this circuit breaker period?
</td>
</tr>
</table>
<table>
  ...
  <tr>
    ...
    <table align="left" border="0" cellpadding="0" cellspacing="0" class="device-width"
      ...
      <td class="mobile-txt" style="cursor:auto;color:#000000;font-family:"PT Sans", "Helvetica Neue", Helvetica, Arial, sans-serif;font-size:18px;line-height:25px;text-align:left;"
        valign="top">
        <span style="font-size: 12px; line-height: 24px; margin: 0; padding: 0;">Date: <strong>08-07-2021</strong></span>
      </td>
      </tr>
      <tr>
      <td class="mobile-txt" style="cursor:auto;color:#000000;font-family:"PT Sans", "Helvetica Neue", Helvetica, Arial, sans-serif;font-size:18px;line-height:25px;text-align:left;"
        valign="top">
        <span style="font-size: 12px; line-height: 24px; margin: 0; padding: 0;">
          Time: <strong>22.00</strong> to <strong>22.30</strong>
        </span>
      </td>
      </tr>
    </table>
    ...
    <table align="right" cellpadding="0" cellspacing="0" class="device-width" role="presentation">
      ...
      <td class="mobile-txt" style="cursor:auto;color:#000000;font-family:"PT Sans", "Helvetica Neue", Helvetica, Arial, sans-serif;font-size:18px;line-height:25px;text-align:right;"
        valign="top">
        <span style="font-size: 18px; line-height: 24px; margin: 0; padding: 0;"><strong>4.5</strong> Rating
        (s)</span>
      </td>
      </tr>
    </table>
    ...
    <table border="0" align="right" cellpadding="0" cellspacing="0" class="product-descriptions" width="300">
      ...
      <td style="cursor:auto;color:#000000;text-align:right;" valign="top">
        <span style="font-weight: 500; font-family:"Montserrat", "Helvetica Neue", Helvetica, Arial, sans-serif;font-size: 13px;line-height:22px;">
          <strong style="color:#919191"><i>Customer Name Here</i></strong>
...
<td valign="top">
  ...
  <tr>
    ...
    <table align="left" border="0" cellpadding="0" cellspacing="0" class="device-width"
      ...
      <td valign="top">
      <img alt="Agent"
          class="product-img"  src="https://erp.cal4care.com/images/edm/omni-chat/agent.jpeg"
          style="outline:none;text-decoration:none;border: none; display: block;"
          width="40" height="40"> <br /></td>
      </tr>
    </table>
    </td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="product-descriptions"
      ...
      <td style="cursor:auto;color:#000000;text-align:left;" valign="top">
        <span class="product-name" style="font-family:"Montserrat", "Helvetica Neue", Helvetica, Arial, sans-serif;font-size: 13px;line-height:22px;">
          <strong style="color: #919191;"><i>Manikandan</i></strong> <span class="Order_Item.Product_Modifications-quantity" style="font-weight: bold; padding-left: 10px; font-family:"PT Sans", "Helvetica Neue", Helvetica, Arial, sans-serif;font-size:12px;line-height:16px;color:#7e7e7e;
        ">
        [ 22.00 ]
        </span><br />
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
...
if($del_stat=='1'){	
  ...
  $chat_data = $this->getChatDetails($chat_msg_id);
   $mc_event_data = "SMS To ".$phone_no;
		  ...
		  $this->db_query("INSERT INTO mc_event (admin_id,mc_event_key,mc_event_data,mc_event_type,event_status,created_dt) VALUES('$admin_id','$phone_no','$mc_event_data','6','7','$created_at')", array());
  return '1';   
...
function generate_incoming_message_from_outer($data){
    ...
    if($result > 0){
      ...
      $qry = "select * from user where user_id='$user_id'";
		...
		$this->db_query("INSERT INTO mc_event (mc_event_data,mc_event_type,event_status,created_dt,admin_id) VALUES('$mc_event_data','6','7','$created_at','$admin_id')", array());
           return $chat_data;  
    }  
}
