...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-knowledge-base-app-knowledge-base-module"], {
  ...
  function srcAppAppKnowledgeBaseAppKnowledgeBaseModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/icon.js"); // import { EditorModule } from '@tinymce/tinymce-angular';
  ...
  function srcAppAppKnowledgeBaseCreateCategoryCreateCategoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CreateCategoryComponent = /*#__PURE__*/function () {
      ...
      _createClass(CreateCategoryComponent, [{
        key: "editadd",
        value: function editadd(event) {
          var value = (event.value || '').trim();
          var input = event.input;

          if (value) {
            this.editsubcateogry.push({
              name: value
            });
            event.value = "";
          }
        ...
        key: "editremove",
        value: function editremove(code) {
          var index = this.editsubcateogry.indexOf(code);
        ...
        value: function getcategory() {
          ...
          this.serverService.sendserver(api_req).subscribe(function (response) {
            ...
            if (response.status == true) {
              ...
              _this2.new_categorylists = [];

              _this2.categorylists.forEach(function (element) {
                var splitted = [];
                ...
                _this2.new_categorylists.push({
                  category_name: element.category_name,
                  subcategory: splitted,
                  id: element.id,
        ...
        value: function postA2(addsubcategory) {
          ...
          this.serverService.sendserver(api_req).subscribe(function (response) {
            ...
            if (response.result.data == 1) {
              ...
              _this3.addsubcategory.reset();

              _this3.getcategory(); //this.router.navigate(['/videoupload'])
              // Swal.close();
        ...
        value: function edit_category(id) {
          ...
          this.serverService.sendserver(api_req).subscribe(function (response) {
            ...
            if (response.status == true) {
              ...
              _this6.edit_cat_id = response.result.data[0].id; // if(response.result.data[0].subcategory !='' &&response.result.data[0].subcategory !=null){
        ...
        key: "RemoveSubcat",
        value: function RemoveSubcat(id) {
          var _this8 = this;
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            ...
            if (result.value) {
              var api_req = '{"operation": "category","moduleType": "category","api_type": "web","element_data": {"action":"delete_sub_category","name":"' + id + '"}}	';

              _this8.serverService.sendserver(api_req).subscribe(function (response) {
                if (response.result.data == 1) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Deleted!', 'success');
        ...
        key: "UpdateSubcat",
        value: function UpdateSubcat(id) {
          var _this9 = this;
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            ...
            if (result.isConfirmed) {
              var update_subcat = result.value;
              ...
              var api_req = '{"operation": "category","moduleType": "category","api_type": "web","element_data": {"action":"update_sub_category","name":"' + id + '","update_name":"' + update_subcat + '"}}	';
  ...
  function srcAppAppKnowledgeBaseDisplaypageDisplaypageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DisplaypageComponent = /*#__PURE__*/function () {
      function DisplaypageComponent(serverService, router, route) {
      ...
      _createClass(DisplaypageComponent, [{
        ...
        value: function getcategory() {
          ...
          this.serverService.sendserver(api_req).subscribe(function (response) {
            ...
            if (response.status == true) {
              _this10.category_list = response.result.data;

              if (_this10.selectedID == 'undefined' || _this10.selectedID == undefined || _this10.selectedID == null) {
                var id = response.result.data[0].id;
                var Jqueryid = 'panel-body_' + id; // $('.accordion-body').removeClass('show'); 
                // setTimeout(() => {
                // $('#'+id).addClass('collapse'); 
                // $('#'+id).addClass('show'); 
                // }, 1000);

                _this10.ShowSinglecategory(Jqueryid, id);
              }

              if (_this10.selectedID != 'undefined' && _this10.selectedID != undefined && _this10.selectedID != null) {
                _this10.selectedID = atob(_this10.selectedID);

                var _id = 'panel-body_' + _this10.selectedID; //  $('.accordion-body').removeClass('show'); 
                //  setTimeout(() => {
                //  $('#'+id).addClass('collapse'); 
                //  $('#'+id).addClass('show'); 
                //  }, 100);
                ...
                _this10.ShowSinglecategory(_id, _this10.selectedID);
              }
            }
          }, function (error) {
            console.log(error);
        ...
        key: "ShowSinglecategory",
        value: function ShowSinglecategory(id, category) {
          var _this11 = this;

          if (!$('#' + id).hasClass('show')) {
            //restrict if already open
            var api_req = '{"operation": "category","moduleType": "category","api_type": "web","element_data": {"action":"ShowSinglecategory","id":"' + category + '"}}';
            this.serverService.sendserver(api_req).subscribe(function (response) {
              console.log(response);

              if (response.status == "true") {
                _this11.category_items = response.data;

                if (_this11.category_items < 1) {
                  _this11.catItemsnotFound = true;
                } else {
                  _this11.catItemsnotFound = false;
                }
              }
            }, function (error) {
              console.log(error);
        ...
        value: function displaycat() {
          ...
          this.serverService.sendserver(api_req).subscribe(function (response) {
            if (response.status == 'true') {
              _this12.category_list = response.data;
              if (_this12.category_list.length == 0) _this12.recordNotFound = true;
            }
          }, function (error) {
            console.log(error);
          });
        ...
        key: "deletepost",
        value: function deletepost(id, category_id) {
          var _this13 = this;
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
            ...
            if (result.value) {
              ...
              _this13.serverService.sendserver(api_req).subscribe(function (response) {
                if (response.result.data == 1) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Deleted!', 'success');
                  var j_id = 'panel-body_' + category_id;
                  $('#' + j_id).removeClass('show');

                  _this13.ShowSinglecategory(j_id, category_id); //this.getcategory();
      ...
      _createClass(EditPageComponent, [{
        ...
        value: function getedit() {
          ...
          this.serverService.sendserver(api_req).subscribe(function (response) {
            ...
            if (response.status == true) {
              // console.log("asdf")
              console.log(_this16.param);
              _this16.editlist = response.result.data[0];
              _this16.catselect = response.result.data[0].category_id;
              _this16.post_status = _this16.editlist.status;
              console.log('Cat  ' + _this16.catselect);

              _this16.getsubcategory();

              $('#edit_post_title').val(_this16.editlist.post_title);
              tinymce.get('edit_ck_editor').setContent(atob(_this16.editlist.post_content));
              if (response.result.data[0].featured == '1') $("#edit_featured").prop('checked', true);

              _this16.editform.setValue({
                // 'post_title':this.editlist.post_title,
                'catselect': _this16.editlist.category_id,
                'subcatselect': _this16.editlist.subcat_id,
                'displaytype': _this16.editlist.display_type
              });
            }
          }, function (error) {
            console.log(error);
        ...
        value: function update(editform) {
          ...
          var api_req = '{"operation": "category","moduleType": "category","api_type": "web","element_data": {"action":"update_doc_post","post_title":"' + post_title + '","status":"' + status + '","category_id":"' + catselect + '","subcat_id":"' + subcatselect + '","post_content":"' + ck_editor + '","id":"' + this.param + '","display_type":"' + displaytype + '","featured":"' + featured + '"}}';
          this.serverService.sendserver(api_req).subscribe(function (response) {
            ...
            if (response.result.data == 1) {
              _this17.router.navigate(['/kb/displaypage'], {
                queryParams: {
                  selectedID: btoa(_this17.catselect)
                }
              });
            }
          }, function (error) {
      ...
      _createClass(UploadpageComponent, [{
        ...
        value: function getcategory() {
          ...
          this.serverService.sendserver(api_req).subscribe(function (response) {
            ...
            if (response.status == true) {
              // console.log("asdf")
              _this18.categorylists = response.result.data;
            }
          }, function (error) {
            console.log(error);
          });
        ...
        value: function getsubcategory() {
          ...
          this.serverService.sendserver(api_req).subscribe(function (response) {
            ...
            if (response.status == true) {
              // console.log("asdf")
              _this19.subcategorylists = response.result.data;
            }
          }, function (error) {
            console.log(error);
          });
        ...
        value: function postupload(uploadform) {
          ...
          var subcat_id = $("#subcatselect").val();
          var quote_content = '';
          var post_by = $("#opt").val();
          var featured = '0';
          ...
          $.ajax({
            ...
            success: function success(data) {
              ...
              if (result.data == 2) {
                ...
                self.router.navigate(['/kb/displaypage'], {
                  queryParams: {
                    selectedID: btoa(self.catselect)
                  }
      ...
      _createClass(VideoUploadComponent, [{
        ...
        value: function getcategory() {
          ...
          this.serverService.sendserver(api_req).subscribe(function (response) {
            ...
            if (response.status == true) {
              // console.log("asdf")
              _this20.categorylists = response.result.data;
            }
          }, function (error) {
            console.log(error);
          });
        ...
        value: function getsubcategory() {
          ...
          this.serverService.sendserver(api_req).subscribe(function (response) {
            ...
            if (response.status == true) {
              // console.log("asdf")
              _this21.subcategorylists = response.result.data;
            }
          }, function (error) {
            console.log(error);
          });
        ...
        value: function postdata(videoform) {
          ...
          this.serverService.sendserver(api_req).subscribe(function (response) {
            ...
            if (response.result.data == 1) {
              _this22.posts = response.result.data;
              iziToast.success({
                message: "Video link added",
                position: 'topRight'
              });

              _this22.router.navigate(['/kb/displaypage']);
            }
          }, function (error) {
            console.log(error);
          });
...
//# sourceMappingURL=app-knowledge-base-app-knowledge-base-module-es5.ecc7b8792d0b1bc1f131.js.map